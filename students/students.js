  ...
  document
    ...
    .addEventListener("submit", (e) => {
      ...
      const lastName = document.getElementById(
        "modal__addEdit_LastNameInput"
      ).value;
      const gender = document.getElementById(
        "modal__addEdit_GenderInput"
      ).value;
      const birthday = document.getElementById(
        "modal__addEdit_BirthdayInput"
      ).value;
      ...
      if (studentToEdit) {
        ...
        status_img.src =
          count % 2 == 0 ? "../assets/online.svg" : "../assets/offline.svg";
        ...
        delete_btn.addEventListener("click", (e) => {
          if (
            e.target.closest("tr").firstChild.firstChild.firstChild.checked ==
            false
          )
            return;
